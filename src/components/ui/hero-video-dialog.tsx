  ...
  return (
    <div className={cn("relative", className)}>
      ...
      >
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent rounded-md flex items-end justify-center p-3">
          <h2 className="text-white text-lg md:text-2xl font-semibold text-center">{title}</h2>
        </div>
